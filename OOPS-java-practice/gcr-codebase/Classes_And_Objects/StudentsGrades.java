...
public class StudentsGrades {
	...
	public String calculateGrade(double[] marks ) {
		...
		//to check the grade of students
	...
	public static void main(String[] args) {
		...
		StudentsGrades student1 = new StudentsGrades("Hritik", "BCSE2001", mark1);
		StudentsGrades student2 = new StudentsGrades("Praveen","BCSE2004",mark2);
